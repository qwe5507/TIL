...
![Untitled](https://s3-us-west-2.amazonaws.com/secure.notion-static.com/ae8e42f6-2fc1-4c1b-8db8-ad54d42dcf42/Untitled.png)
...
![Untitled](https://s3-us-west-2.amazonaws.com/secure.notion-static.com/12efe5ba-c661-453e-814b-c61534615b70/Untitled.png)
...
- 근데 이 방식은 클래스 로딩 순서에 너무 의존적이기 때문에 이 방식은 삭제
...
- Instrumentation을 사용한다.
    - Instrumentation을 구현할때 `asm`또는 `bytebuddy`를 사용해야 한다.
...
agent를 jar로 패키징 하면서 jar파일 안에다 특정한 값들을 넣어 줘야 한다.

jar로 묶을때 manifest를 조작 할 수있는,? 

menifest를 jar plugin으로 만들 때 아래 페이지 참고
